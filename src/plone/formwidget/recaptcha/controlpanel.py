...
class ReCaptchaSettingsEditForm(controlpanel.RegistryEditForm):
    ...
    description = _(
        ...
        u" https://host/path/to/site/@@recaptcha-settings. If you don't want"
        u" to rely on an external service for captcha, you might want to"
        u" consider using plone.formwidget.captcha instead."
    )
